package com.example.paging_library.adapters
...
import com.example.nav_components_2_tabs_exercise.databinding.ItemUserBinding
import com.example.paging_library.views.UserListItem


/**
 * Adapter for rendering users in a RecyclerView.
 *
 */
class UserAdapter(
private val listener: Listener
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        with(holder.binding) {
            ...
            userProgressBar.isInvisible = user.inProgress
    ...
    interface Listener {
        ...
        /**
         * Called when user taps "Star" button in a list item.
         */
