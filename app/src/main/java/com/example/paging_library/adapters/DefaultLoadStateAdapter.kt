...
import com.example.nav_components_2_tabs_exercise.databinding.PartDefaultLoadStateBinding
...
/**
 * This adapter is used for rendering tho load state (ProgressBar, error message and Try Again button)
